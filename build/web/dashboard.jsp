	...
	<div class="content-wrapper">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
                                    <a href="admin-view-customers.jsp">	
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
                                    <a href="admin-view-contacts.jsp">
					<div class="alert alert-danger back-widget-set text-center">
						...
						Total Contacts
                                                ...
                                                <div class="row">
                                                  <div class="col-md-3 col-sm-3 col-xs-6">
                                    <a href="admin-view-sales.jsp">
					<div class="alert alert-info back-widget-set text-center">
						<i class="fa fa-history fa-5x"></i>
						<%
							ResultSet totalSales=DatabaseConnection.getResultFromSqlQuery("select sum(product_total_price) from tblorders");
							totalSales.next();
						...
						Total Sales
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <a href="admin-view-employee.jsp">	
                                    <div class="alert alert-success back-widget-set text-center">
						<i class="fa fa-users fa-5x"></i>
						<%
							ResultSet totalEmp=DatabaseConnection.getResultFromSqlQuery("select count(*) from tblemployee");
							totalEmp.next();
							int te=totalEmp.getInt(1);
						%>
						<h3><%=""+te %></h3>
						Total Employees
					</div>
