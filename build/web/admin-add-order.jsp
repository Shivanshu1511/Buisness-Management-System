				...
				<div class="col-md-12">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AdminAddOrder" method="post"
								>
                                                            <div class="form-group">
									<label>Select Product</label> 
                                                                        <select name="ddl_customer">
									...
									%>
                                                                        <option value="<%=resultSet.getInt("id")%>"><%=resultSet.getString("name")+"-"+resultSet.getString("phone")%></option>
                                                                        <%
                                                                            }
                                                                            %>
                                                                        </select>
								...
								<div class="form-group">
									<label>Select Product</label> 
										...
										ResultSet resultSet1 = statement.executeQuery("select * from tblproduct order by product_category, name");
										while (resultSet1.next()) {
									%>
                                                                        <option value="<%=resultSet1.getInt("id")%>"><%=resultSet1.getString("product_category")+" - "+resultSet1.getString("name")%></option>
                                                                        <%
                                                                            }
                                                                            %>
                                                                        </select>
