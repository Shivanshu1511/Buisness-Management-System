					...
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li><a href="#" class="dropdown-toggle" id="ddlmenuItem"
							...
							<ul class="dropdown-menu" role="menu"
								aria-labelledby="ddlmenuItem">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-add-order.jsp">Add Order</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
						...
						<li><a href="#" class="dropdown-toggle" id="ddlmenuItem"
							...
							<ul class="dropdown-menu" role="menu"
								aria-labelledby="ddlmenuItem">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-add-customer.jsp">Add Customer</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
								...
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-view-contacts.jsp">View Contacts</a></li>
                                                        ...
                                                        <li><a href="#" class="dropdown-toggle" id="ddlmenuItem"
							data-toggle="dropdown">Employees <i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu" role="menu"
								aria-labelledby="ddlmenuItem">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-add-employee.jsp">Add Employee</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-view-employee.jsp">View Employees</a></li>
