...
<body>
	...
	<div class="content-wrapper">
		<div class="container">
			...
			%>
			<div class="alert alert-danger" id="success"><%=message==null?"NA":message%></div>
			<%
				}
			%>
			<div class="row">
							...
							<form role="form" action="AddEmployee" method="post"
								...
								<div class="form-group">
									<label>Enter Name</label> <input class="form-control"
										type="text" name="emp_name" required/>
								</div>
								<div class="form-group">
								...
								<button type="submit" class="btn btn-success" onclick="return confirm('Are you sure Do you want to add this employee?');">Add
									Employee</button>
