			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">Date and Product Wise Sales Report</div>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<%
										ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select Date(order_date) as order_date, product_name, sum(product_total_price) as ts from tblorders group by product_name,Date(order_date)");
									while (rs.next()) {
									%>
									<tbody>
										<tr>
